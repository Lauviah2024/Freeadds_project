<x-main-layout>
    <div class="flex flex-col justify-center items-center w-full h-full">
        <form enctype="multipart/form-data" action="{{ route('ads.store') }}" method="POST"
                ...
                <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input required type="text" name="title" id="title" autocomplete="title"
                                    class="block w-full rounded-md focus:outline-none border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('title')
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input required type="number" name="price" id="price" autocomplete="price"
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <textarea  required name="description"  id="description" autocomplete="description"
                                    class="block w-full rounded-md border-0 focus:outline-none py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </textarea>
                            </div>
                            @error('description')
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input required type="number" name="location" id="location" autocomplete="location"
                                    class="block w-full rounded-md border-0 focus:outline-none py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('location')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    <label for="uploadFile1"
                        ...
                        <input required type="file" id='uploadFile1' name="image" class="hidden" />
